...
const ExamHeader = () => {
  const [openExamCreateModal, setOpenExamCreateModal] = useState(false);
  ...
  return (
    ...
    >
      ...
      <Stack direction="row" spacing={2} alignItems="center">
        <EditNoteIcon style={{height:'52', width:'52', color: '#6c5ce7'}} />
        <Box>
          <Typography variant="h6" fontWeight="bold">
            Exam Management
          </Typography>
          <Typography variant="body2" color="textSecondary">
            Create Exam and Marks Entry.
          </Typography>
        </Box>
      </Stack>
      ...
      <Box flex={1} minWidth={300} display="flex" justifyContent="flex-end" gap={2}>
        <Stack direction="row" spacing={1} alignItems="center" flexWrap="wrap">
          ...
          <CustomButton
            variant="contained"
            startIcon={<AddIcon />}
            onClick={()=> setOpenExamCreateModal(true)}
          >
            New Exam
          </CustomButton>
        </Stack>
      </Box>
      {
        openExamCreateModal && (
          <AddOrEditExamModal
            open={openExamCreateModal}
            onClose={()=>setOpenExamCreateModal(false)}
          />
        )
      }
    </Box>
