...
const StudentFeesHeader = () => {
  const [openAddStudentFeesModal, setOpenAddFeesStudentModal] = useState(false);
  ...
  return (
    ...
    >
      ...
      <Stack direction="row" spacing={2} alignItems="center">
        ...
        <Box>
          ...
          <Typography variant="body2" color="textSecondary">
            Track monthly and exam fees for all students
          </Typography>
        </Box>
      </Stack>
      ...
      <Box flex={1} minWidth={300} display="flex" justifyContent="flex-end" gap={2}>
        <Stack direction="row" spacing={1} alignItems="center" flexWrap="wrap">
          ...
          <CustomButton
            variant="contained"
            startIcon={<AddIcon />}
            onClick={()=> setOpenAddFeesStudentModal(true)}
          >
          Add Student Fee
          </CustomButton>
        </Stack>
      ...
      {
        openAddStudentFeesModal && (
          <AddOrEditStudentFeesModal
          open={openAddStudentFeesModal}
          onClose={()=> setOpenAddFeesStudentModal(false)}
          />
        )
      }
    </Box>
